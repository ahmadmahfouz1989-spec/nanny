...
begin
  ...
  insert into public.nanny_profiles (
    ...
    true, true, '{"first_aid_cpr"}', 'Warm and experienced nanny based in Achrafieh.',
    'active', 'pending'
  ...
  insert into public.nanny_profiles (
    ...
    false, false, '{}', 'Reliable part-time caregiver in Jounieh, great with babies.',
    'active', 'pending'
  ...
  insert into public.nanny_profiles (
    ...
    true, true, '{"first_aid_cpr","early_childhood_ed"}',
  ...
  insert into public.parent_profiles (
    ...
    'full_time', 'live_out', current_date + interval '3 weeks',
  ...
  insert into public.parent_profiles (
    ...
    'part_time', 'either', current_date + interval '2 weeks',
  ...
  insert into public.parent_profiles (
    ...
    'either', 'live_in', current_date + interval '1 month',
