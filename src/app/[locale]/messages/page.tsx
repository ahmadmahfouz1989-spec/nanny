...
export default function MessagesPage() {
  ...
  return (
    <div className="h-screen flex flex-col">
      <header className="flex items-center justify-between px-6 sm:px-10 py-4 border-b border-border shrink-0">
        <BrandMark />
      ...
      <div className="flex-1 flex min-h-0">
        ...
        >
          <div className="px-4 py-3 border-b border-border shrink-0">
            <Link href="/dashboard" className={ui.link + " text-xs"}>
              {tMatches("backToDashboard")}
            </Link>
            <h1 className="font-display text-xl font-bold mt-1">{t("title")}</h1>
          </div>
