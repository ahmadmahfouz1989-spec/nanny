...
const SUPPORT_INSTAGRAM =
  process.env.NEXT_PUBLIC_SUPPORT_INSTAGRAM || "https://www.instagram.com/ouiknowww?stkn=MTNseHg4ZHNicm1taw==";
      ...
      <footer className="border-t border-border px-6 py-10 sm:px-10">
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-4 text-center text-xs text-muted">
          <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2">
            ...
            >
              <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor" aria-hidden>
                <path d="M12 2.16c3.2 0 3.58.01 4.85.07 1.17.05 1.8.25 2.23.41.56.22.96.48 1.38.9.42.42.68.82.9 1.38.16.43.36 1.06.41 2.23.06 1.27.07 1.65.07 4.85s-.01 3.58-.07 4.85c-.05 1.17-.25 1.8-.41 2.23-.22.56-.48.96-.9 1.38-.42.42-.82.68-1.38.9-.43.16-1.06.36-2.23.41-1.27.06-1.65.07-4.85.07s-3.58-.01-4.85-.07c-1.17-.05-1.8-.25-2.23-.41a3.72 3.72 0 0 1-1.38-.9 3.72 3.72 0 0 1-.9-1.38c-.16-.43-.36-1.06-.41-2.23-.06-1.27-.07-1.65-.07-4.85s.01-3.58.07-4.85c.05-1.17.25-1.8.41-2.23.22-.56.48-.96.9-1.38.42-.42.82-.68 1.38-.9.43-.16 1.06-.36 2.23-.41C8.42 2.17 8.8 2.16 12 2.16Zm0 1.62c-3.14 0-3.5.01-4.73.07-1.03.05-1.6.22-1.97.36-.5.19-.85.42-1.22.79-.37.37-.6.72-.79 1.22-.14.37-.31.94-.36 1.97-.06 1.23-.07 1.59-.07 4.73s.01 3.5.07 4.73c.05 1.03.22 1.6.36 1.97.19.5.42.85.79 1.22.37.37.72.6 1.22.79.37.14.94.31 1.97.36 1.23.06 1.59.07 4.73.07s3.5-.01 4.73-.07c1.03-.05 1.6-.22 1.97-.36.5-.19.85-.42 1.22-.79.37-.37.6-.72.79-1.22.14-.37.31-.94.36-1.97.06-1.23.07-1.59.07-4.73s-.01-3.5-.07-4.73c-.05-1.03-.22-1.6-.36-1.97a3.28 3.28 0 0 0-.79-1.22 3.28 3.28 0 0 0-1.22-.79c-.37-.14-.94-.31-1.97-.36-1.23-.06-1.59-.07-4.73-.07Zm0 4.38a5.84 5.84 0 1 1 0 11.68 5.84 5.84 0 0 1 0-11.68Zm0 1.62a4.22 4.22 0 1 0 0 8.44 4.22 4.22 0 0 0 0-8.44Zm6.06-1.8a1.36 1.36 0 1 1-2.72 0 1.36 1.36 0 0 1 2.72 0Z" />
              </svg>
              {tNav("instagram")}
            </a>
          </div>
